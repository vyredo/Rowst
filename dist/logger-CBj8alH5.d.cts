 ...
 */
declare function isTransportReady(transport: Transport): boolean;
/**
 * Type guard for transport 'closed' or 'closing' state
 */
declare function isTransportClosed(transport: Transport): boolean;
...
export { ConsoleTransport as C, Logger as L, NoopTransport as N, type Transport as T, type LoggerOptions as a, LogLevel as b, type LogTransport as c, type TransportEvents as d, type TransportState as e, isTransportReady as f, isTransportClosed as i };
